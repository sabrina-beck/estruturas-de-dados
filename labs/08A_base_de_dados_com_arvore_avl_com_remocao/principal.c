 ...
 * sobre uma árvore AVL.
 *
 *  Comandos aceitos:
 *       i <ra> <nome> insere novo nó com ra e nome
 *       c <ra>        consulta ra
 *       d             imprime a árvore sob forma gráfica
 *       r <ra>        remove ra, caso exista
 *       n  imprime o número de nós na árvore
 *       a  imprime a altura da árvore
 ...
 *      testada no fim utilizando a função 'bapply(bprint)'.
 */
...
void ErroAVL() {
  ...
  fprintf(stderr,"Erro na implementação da árvore AVL.\n");
  exit(0);
}
...
/* Verifica se a árvore apontada por 'p' tem a estrutura de uma árvore
...
int main() {
  ...
  do { 
	...
	printf("n             : imprime o número de nós na base.\n");
